clear;
assignin('base','Kp',7.9733);
assignin('base','Ki',0.2238);
assignin('base','Lambda',-0.9693);
%
assignin('base','ioKp',8.55);
assignin('base','ioKi',8.79);
assignin('base','ioKd',1.85);

assignin('base','tau',0.2486);
assignin('base','k',0.99217);
